  ...
  \begin{columns}[onlytextwidth]%
    ...
    \begin{column}{0.4\textwidth}%
      \begin{block}[equal height group=F]{Recent updates of PROPOSAL}%
        ...
        \begin{itemize}
          \setlength\itemsep{\itemseparation}
          \item Simulation of stochastic deflections, i.e. deflections of particles in hard losses
          \begin{itemize}
            \setlength\itemsep{\itemseparation}
            \item[$\rightarrow$] Muon deflections due to multiple scattering and stochastic deflections might be a source of uncertainty in directional reconstructions \cite{gutjahr2022}
          \end{itemize}
        \end{itemize}
        \begin{figure}
  ...
  \begin{columns}[onlytextwidth]%
    ...
    \begin{column}{\thirdtextwidth}%
      \begin{block}[equal height group=B]{Application: Neutrino telescopes}%
        \begin{itemize}
          \setlength\itemsep{\itemseparation}
          \item PROPOSAL is used by neutrino telescopes, for example in the IceCube Neutrino observatory
          \item Simulation of muon and tau energy losses in ice
          \begin{itemize}
            \setlength\itemsep{\itemseparation}
            \item[$\rightarrow$] Accurate description of interaction cross sections necessary
          \end{itemize}
